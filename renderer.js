...
const configFile = require('os').homedir() + '/Genesis-Launcher.json';
var config = {folder: 'C:\\SWG_Genesis'};
...
discordBtn.addEventListener('click', event => shell.openExternal("https://discord.gg/se4hRN4F7w"));
